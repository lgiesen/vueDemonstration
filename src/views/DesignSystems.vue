  ...
  div.designsystems
    v-container.text-center
      ...
      p There are various design languages, for instance Lighting Design System 
        ...
        | - Discover Best Design Languages and Design Systems, n.d.).Firstly, Google’s
        | Material Theme is very popular and can be used with the front-end libraries
        ...
        | motion are used in Material Design system should be defined.Apple’s design
        | guidelines use clarity, deference and depth rules for their themes. In detail
        ...
        | hover and click effects keeps the user engaged. Fifth, metaphors sparks interest
