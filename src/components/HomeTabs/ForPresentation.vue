<template lang="pug">
    v-container.ForPresentation 
        h3.mt-5 What is our situation and what do we need?
        ...
        h3.mt-10 Which front-end framework or libary suits our project?
            ...
            v-simple-table
                ...
                tbody
                    tr
                        td Type
                        td Framework
                        td Library (freedom vs choices)
                        td Framework
                    tr
                        td Volume &rarr; Startup &amp; 
                            br 
                            | Runstime Performance
                        td Large
                        td Medium/Small
                        td Small
                    tr  
                        td Built-in Functionalities
                        td Large variety
                        td Very Basic: Only Dom Manipulation 
                            br
        ...
        h2.text-center.margin &rarr; Vue
