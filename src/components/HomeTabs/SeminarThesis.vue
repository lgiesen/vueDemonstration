...
<template lang="pug">
    v-container.SeminarThesis
      v-row
        v-col
          div.pa-2.mt-10
          h3.mb-3 1.1	Classification in the Context of the Project Seminar
          p This seminar thesis is part of the seminar „Game of Competences”, which 
        ...
        v-col
          div.pa-2.mt-10
          h3.mb-3 1.2	Use Cases and Relevance of Front-End Frameworks
          p In contrast to an unpretentious and simple front-end, a complex website needs 
      ...
      v-row 
        div.pa-2.mt-10
          h3.mb-3 1.3	Evaluation of Angular, React and Vue.js
          p The most significant front-end frameworks and libraries at the moment are Angular, 
